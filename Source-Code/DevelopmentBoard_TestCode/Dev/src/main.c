...
int main(void)
{
	...
	uint8_t txBuff[buffSize];
	uint8_t tx2Buff[8] = "MSPW3000";
	uint8_t tx3Buff[7] = "MANW100";
	//led_on(DEBUG_LED_0);
	...
	while (1)
	{
		...
		timer_ms_delay(100);
		i2c_master_send_buffer(MOTOR_ADDRESS,tx2Buff,8);
		timer_ms_delay(100);
		i2c_master_send_buffer(MOTOR_ADDRESS,tx3Buff,7);
		timer_ms_delay(100);
		i2c_master_recv_buffer(MOTOR_ADDRESS, txBuff,7);
		timer_ms_delay(100);
		//timer_ms_delay(1000);
		//led_toggle(DEBUG_LED_0|DEBUG_LED_1);
	}
